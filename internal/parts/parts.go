...
// Part is an interface to be implemented by all parts.
type Part interface {
	String() string // String-like output for debugging purposes
	ToSql() string  // Translate part to its Sql equivalent
}

// qualifiedExpression represents an expression that might or might be not
